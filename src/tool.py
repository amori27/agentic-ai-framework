...
ToolFunction = SyncCallable | AsyncCallable
...
def get_default_tools() -> list[Tool]:
    return [
        create_function_tool(
            "web_search", "Search the web for information", web_search_tool
        ),
        create_function_tool(
            "calculator", "Evaluate a mathematical expression", calculator_tool
        ),
        create_function_tool(
            "file_reader", "Read contents of a file", file_reader_tool
        ),
    ]
...
def get_async_default_tools() -> list[Tool]:
    return [
        create_function_tool(
            "web_search", "Search the web for information", web_search_tool_async
        ),
        create_function_tool(
            "calculator", "Evaluate a mathematical expression", calculator_tool
        ),
        create_function_tool(
            "file_reader", "Read contents of a file", file_reader_tool_async
        ),
    ]
